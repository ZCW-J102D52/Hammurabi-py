...
class Display:
    ...
    def format_royal_report(year_object):
        ...
        second_line = f"In the previous year {year_object.peopleStarved} people starved to death."
        ...
        fifth_line = f"We harvested {year_object.harvest} bushels at {year_object.fertility} bushels per acre."
